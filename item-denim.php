...
<html>
	<head>
		<title> AWAN Outer | Shinshi </title>
			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-denim4.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-denim2.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-denim3.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-denim1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-denim-hover.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-denim4.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-denim2.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-denim3.jpg" onclick = "currentSlide(3)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-denim1.jpg" onclick = "currentSlide(4)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-denim-hover.jpg" onclick = "currentSlide(5)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> AWAN Outer  </h1><br><br>
						<p> RM 189.00 </p><br><br>
						<p> Went rogue. Express your true spirit of rebellion in stylish way.
							Bad lookin yet admiring spectators.

						</p>
						<br><br>
						<div class = "item-button-container">
							<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="outer02" />
