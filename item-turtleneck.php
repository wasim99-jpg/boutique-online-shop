			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-turtleneck2.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-turtleneck1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-turtleneck3.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-turtleneck4.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-turtleneck-hover.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-turtleneck2.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-turtleneck1.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-turtleneck3.jpg" onclick = "currentSlide(3)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-turtleneck4.jpg" onclick = "currentSlide(4)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-turtleneck-hover.jpg" onclick = "currentSlide(5)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> PEYU Top  </h1><br><br>
						<p> RM 109.00 </p><br><br>
						<p>A simple and classic design that is comfortable and super elastic to wear.  It is easy to dress up and create your own styles. Suitable for all ages and different occasions  </p>
						<br><br>
						<div class = "item-button-container">
							<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="top04" />
