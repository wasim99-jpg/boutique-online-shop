...
<html>
	<head>
		<title> SEYUM Socks | Shinshi </title>
			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-socks1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-socks2.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-socks1.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-socks2.jpg" onclick = "currentSlide(2)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> SEYUM Socks  </h1><br><br>
						<p> RM 12.00 </p><br><br>
						<p> Cute funky socks that are super soft and stretchy. Made from combed cotton blend for breathability. </p>
						<br><br>
						<div class = "item-button-container">
							<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="socks01" />
