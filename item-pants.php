...
<html>
	<head>
		<title> LABU Pants | Shinshi </title>
			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-pants1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-pants2.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-pants3.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-pants1.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-pants2.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-pants3.jpg" onclick = "currentSlide(3)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> LABU Pants  </h1><br><br>
						<p> RM 89.00 </p><br><br>
						<p> A drawstring slim fit and midrise pants made from cotton blend. Super comfortable for your everyday use. </p>
						<br><br>
						<div class = "item-button-container">
									<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="pants01" />
