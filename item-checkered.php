			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-checkered1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-checkered2.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-checkered3.jpg"> 
						</div>
						
						<div class = "item-image">
							<img src = "item-checkered4.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-checkered-hover.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-checkered1.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-checkered2.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-checkered3.jpg" onclick = "currentSlide(3)"> 
							</div>
							
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-checkered4.jpg" onclick = "currentSlide(4)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-checkered-hover.jpg" onclick = "currentSlide(5)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> PETAK Top  </h1><br><br>
						<p> RM 119.00 </p><br><br>
						<p> Baggy shirt that makes you feel young again.
							Cozy and chill can be seems by miles away by the checkered pattern.
							</p>
						<br><br>
						<div class = "item-button-container">
									<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="top03" />
