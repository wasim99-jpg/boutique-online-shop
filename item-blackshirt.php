...
<html>
	<head>
		<title> NOIR Shirt | Shinshi </title>
			...
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-blackshirt3.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-blackshirt.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-blackshirt2.jpg"> 
						</div>
						
						<div class = "item-image">
							<img src = "item-blackshirt4.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-blackshirt5.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-blackshirt-hover.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt3.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt2.jpg" onclick = "currentSlide(3)"> 
							</div>
							
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt4.jpg" onclick = "currentSlide(4)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt5.jpg" onclick = "currentSlide(5)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-blackshirt-hover.jpg" onclick = "currentSlide(6)"> 
							</div>
						</div>
					</div>
				</div>
				...
				<div class = "item-details-container">
					<div class = "item-description">
						<h1> NOIR Shirt  </h1><br><br>
						<p> RM 59.00 </p><br><br>
						<p> Basic that's perfect for daily basis. Can be worn for casual or layer it with outer. 
							Made out of cotton linen where it will produce sense of cold for the skin.
						 </p>
						<br><br>
						<div class = "item-button-container">
						<form method='post' action=''  onsubmit="myFunction()">
			  <input type='hidden' name='code' value="shirt01" />
