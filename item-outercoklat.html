...
<html>
	<head>
		<title> OSAMA Outer | Shinshi </title>
	...
	<body>
		...
		<div class = "fade-container">
			<div class = "item-big-container">
				<div class = "item-image-container">
					<div class = "item-imageslider-container">
						<div class = "item-image">
							<img src = "item-outercoklat1.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-outercoklat2.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-outercoklat3.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-outercoklat4.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-outercoklat5.jpg"> 
						</div>
						<div class = "item-image">
							<img src = "item-outercoklat-hover.jpg"> 
						</div>
						...
						<div class = "item-slider">
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat1.jpg" onclick = "currentSlide(1)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat2.jpg" onclick = "currentSlide(2)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat3.jpg" onclick = "currentSlide(3)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat4.jpg" onclick = "currentSlide(4)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat5.jpg" onclick = "currentSlide(5)"> 
							</div>
							<div class = "item-slider-image">
								<img class="demo cursor" src = "item-outercoklat-hover.jpg" onclick = "currentSlide(6)"> 
							</div>
						</div>
					</div>
				</div>
			  ...
			  <input type='hidden' name='code' value="top01" />
